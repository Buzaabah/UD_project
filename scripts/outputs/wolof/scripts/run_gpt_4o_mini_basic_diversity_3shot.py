...
def main():
    # Configuration
    config = {
        'name': 'gpt_4o_mini_basic_diversity_3shot',
        'description': 'OpenAI experiment: gpt-4o-mini, basic, diversity, 3 examples',
        'llm': {
            'model': 'gpt-4o-mini',
            'max_tokens': 2000,
            'temperature': 0.0,
    ...
    print(f"🚀 Starting OpenAI experiment: gpt_4o_mini_basic_diversity_3shot")
    print(f"⚙️  Model: gpt-4o-mini")
    print(f"📝 Template: basic") 
    print(f"🎯 Selection: diversity")
    print(f"📊 Examples: 3, Test size: 5")
    ...
    try:
        ...
        if results:
            ...
            pipeline.reporter.export_results_to_json(results, f'{results_dir}/gpt_4o_mini_basic_diversity_3shot_results.json')
            pipeline.reporter.export_results_to_csv(results, f'{results_dir}/gpt_4o_mini_basic_diversity_3shot_detailed.csv')
            ...
            print(f"\n💾 Results saved:")
            print(f"  JSON: {results_dir}/gpt_4o_mini_basic_diversity_3shot_results.json")
            print(f"  CSV:  {results_dir}/gpt_4o_mini_basic_diversity_3shot_detailed.csv")
